...
fn has_three_vowels(provided_string: &str) -> bool {
    lazy_static! {
...
fn two_of_same_letters_in_a_row(provided_string: &str) -> bool {
...
fn illegal_char_group(provided_string: &str) -> bool {
    lazy_static! {
...
fn contains_repeating_char_pair(provided_string: &str) -> bool {
    let mut tmp = provided_string.to_string().clone();
...
fn contains_x_something_x (provided_string: &str) -> bool {
    let mut x = '0';
    let mut y = '1';
...
fn is_string_nice_part_one (provided_string: &str) -> bool {
...
fn is_string_nice_part_two (provided_string: &str) -> bool {
...
fn main() {
    ...
    for line in f.split("\n") {
        ...
        // if is_string_nice_part_one(&line) { i += 1; }
        if is_string_nice_part_two(&line) { j += 1; }
